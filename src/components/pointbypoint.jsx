...
function Pointbypoint() {
    ...
    function Read_Expository() {
        ...
        <>
            ...
            A five-paragraph compare and contrast essay using point by point method is an essay that analyzes the similarities 
            and differences between two subjects or ideas. It follows a format consisting of an introduction, 
            three body paragraphs, and a conclusion. Each body paragraph will discuss both subjects and focus on a distinct 
            similarity they share, or a difference between them. 
            </Modal.Body>
            </Modal>
        </>
        );
    ...
    return (
      <>
        <div className="essay-div">
            <h1 className="essay-div-title">Point by Point Compare & Contrast Essay <Read_Expository/></h1>
