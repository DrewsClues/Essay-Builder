...
function Blockmethod() {
    ...
    function Read_Expository() {
        ...
        <>
            ...
            <Modal.Header closeButton>
                ...
                What is an Compare & Contrast Essay?
                </Modal.Title>
            </Modal.Header>
            <Modal.Body className='about_modal_body'>
            A four-paragraph compare and contrast essay using Block Method is an essay that analyzes the similarities 
            and differences between two subjects or ideas. It follows a format consisting of an introduction, 
            two body paragraphs, and a conclusion. The first body paragraph will discuss one subject, and three points about it. 
            The second body paragraph will discuss the other subject, and the same three points about it. 
            </Modal.Body>
            </Modal>
        </>
        );
    ...
    //Check for changes in textareas to update check boxes
      ...
      }, [title, introduction, body1, body2, conclusion, titleisChecked]);
    ...
    return (
      <>
        <div className="essay-div">
            <h1 className="essay-div-title">Block Method Compare & Contrast Essay <Read_Expository/></h1>
            ...
            <Accordion defaultActiveKey={['0']} alwaysOpen className="essay-accordion"> 
                ...
                <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                        <p className="essay-instructions" style={{ whiteSpace: 'pre-line' }}>
                            ...
                            <ul>
                                - Background (Explain your topic and the two subjects you'll compare and contrast)
                            </ul>
                            <ul>
                                - Thesis (What are your three main points of comparison between the two subjects?)
                            </ul>
                        <textarea 
                        value={introduction}
                ...
                <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                        <p className="essay-instructions" style={{ whiteSpace: 'pre-line' }}>
                            Begin with a topic sentence that tells the reader which subject you'll be discussing.
                            Try to use about SIX SENTENCES to discuss your first subject and the three points about it. 
                        </p>
                ...
                <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                        <p className="essay-instructions" style={{ whiteSpace: 'pre-line' }}>
                            Begin with a topic sentence that tells the reader which subject you'll be discussing.
                            Try to use about SIX SENTENCES to discuss your second subject and the three points about it. 
                        </p>
                        <div className="button-div">
                            <Evidencetransitions/>
                            <Reinforcementtransitions/>
